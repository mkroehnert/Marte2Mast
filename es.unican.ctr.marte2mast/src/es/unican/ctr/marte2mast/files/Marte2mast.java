...
/**
 * Entry point of the 'Marte2mast' generation module.
 *
 * @generated
 */
public class Marte2mast extends AbstractAcceleoGenerator {

	// Alvaro
	static File mTargetFolder = null;
	static URI mModelURI = null;
	static EObject mModelEObject = null;
	// end Alvaro
	/**
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/es/unican/ctr/marte2mast/files/marte2mast";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "marte2mast" };
	 ...
	 * @generated
	 */
	public Marte2mast(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
	 ...
	 * @generated
	 */
	public Marte2mast(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 2) {
				...
				Marte2mast generator = new Marte2mast(modelURI, folder, arguments);

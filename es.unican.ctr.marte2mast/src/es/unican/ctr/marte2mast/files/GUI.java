...
public class GUI extends JFrame implements ActionListener{
	//refs: http://www.particle.kth.se/~lindsey/JavaCourse/Book/Part1/Java/Chapter09/chooser.html
	private static final long serialVersionUID = 1L;//set to avoid warning

	public static String mFilePath="";
	
	/**
	 * This class is used to filter the type of files shown by JFileChooser. We just want .xml file.
	 *
	 */
	...
	boolean openFile () {
		...
		//fileChooser.setCurrentDirectory (new File (System.getProperties().get("osgi.instance.area").toString().substring(6)));
		// set filter

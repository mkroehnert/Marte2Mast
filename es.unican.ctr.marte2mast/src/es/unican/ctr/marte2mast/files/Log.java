...
/**
 * This class contains a series of methods used to create a log text (that will
 * be saved through an Acceleo template into a file).
 */
public class Log {
	...
	/**
	 * Configures the necessary variables. Called from Acceleo's marte2mast.mtl
	 * template.
	 *
	 * @param createLog
	 *            <code>true</code> if you want the log text to be created,
	 *            <code>false</code> if not Not sure if it's used anymore.
	 * 
	 * @param logDebugText
	 *            <code>true</code> if you want the debug text (created using
	 *            debugPrintln) to be stored, <code>false</code> if not
	 * 
	 * @param printToConsole
	 *            <code>true</code> if you want to print the text to the console
	 *            (using System.out.print...), <code>false</code> if not
	 * 
	 * @param saveToFile
	 *            <code>true</code> if you want the log text to be saved into a
	 *            file, <code>false</code> if not
	 * 
	 * @param modelName
	 *            the name of the Model (used to generate the name of the log
	 *            file)
	 */
	...
	/**
	 * Returns the name of the log file. The name is the model name plus
	 * ".m2m.log"
	 * 
	...
	/**
	 * Adds a String to the log text + "\n" only if mLogDebugText is set to
	 * true.
	 * 
	 * @param theString
	 *            string text to add to the log
	...
	// [TODO] ugly hack/repeated function to bypass some strange things when
	// using logElement in scheduler.mtl
	// if I use logElement in that file, with the correct stereotype name string
	// (i.e. 'SaExecHost')... nothing shows in the log file (?????)
	...
	public static String getFileNameAndLineNumber(StackTraceElement stack) {
		...
		// ummm, just notice the number line it gives is sometimes wrong (near,
